...
\begin{figure}[h]
    \centering{\includegraphics[width=0.75\textwidth]{graphics/ranking/rankingOverallNormalisedAvarageTies.png}}
...
\begin{figure}[h]
    \centering{\includegraphics[width=0.75\textwidth]{graphics/ranking/ranking-healthcare-vs-notNormalised-average-ties.png}}
...
\begin{figure}[h]
    \centering{\includegraphics[width=0.75\textwidth]{graphics/ranking/ranking-ai-experience-normalised-average-ties.png}}
