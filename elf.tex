...
%Tradeoff between accuracy and interpretability, healtcare needs verification
...
%what makes explanations understandable
...
%sum the following paper - used in intro too so maybe not required
...
%views from end-users - medical physisists, no investigation into transparency or explainability, just AI on a top level
...
%Paper that shows AI can be used for Covid diagnosis
...
%Explainablity is needed in the healtcare sector
...
%Patients view remains ignored - a study on what factors matter to patients in radiology
