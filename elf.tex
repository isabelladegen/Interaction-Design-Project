...
AI being used in many application and more and more in high risk application like self-driving cars, healthcare which we focused on\\
With laws like the GDPR having clauses of “Right to explanation” companies are forced to be able to explain their models and this has triggered XAI\\ %https://www.turing.ac.uk/research/impact-stories/a-right-to-explanation
Explosion of research into Explainable AI, Trustworthy AI, Interpretable AI (short definition of these terms)\\
New techniques are being developed for being able to interpret and explain the outcomes of glass and black black box models\\

%Why new
%The problem (drama): loads of research, not many survey on what's needed on trust, does transparency and explainable creates more or less trust
There is an increasing body of work that critiques the current approach for explainable and trustworthy AI. But are the interpretations possible and explanations given by these techniques helpful to increase trust in AI? Are the explanations what people need and what the law intended to achieve?\\
It’s a mythos\\
The current techniques don’t explain the models in a way that it would increase trust\\
The explanations are not trustworthy, they might not even be correct\\
Is the push for interpretable AI that can deliver explanation being made at the cost of using less capable AI\\
Discuss the trade of between performance of the model and interpretability\\
There is a lack of research around what the end users affected by such systems wants/needs and if the current techniques give them what they want and how this changes by demographic\\
...
We picked a high-stakes application area of health where AI is being used to help a health diagnosis but we put everybody in the shoes of the end user (imagine you’re being diagnosed)\\
We asked xxx people with various different backgrounds to share how much they would trust an AI system to make a diagnosis in four different scenarios: 	(see Appendix for questionnaire)\\
We then analysed which scenario people trust the most as well as if this changes depending on if they have experience with AI, working in health care or not and are making decisions that can significantly impact other people, we call these high-stakes decisions.\\
Results: we’ve found that\ldots\\
We followed up with a focus group of 6 people inviting demographics (x) to discuss and reflect further on their thoughts about AI and the need for interpretability/explanations as well as if black box models just never will be accepted\\
We found that the dislike of the black box has not so much to do with it not being interpretable, but more with the lack of empathy that a machine can give\\
