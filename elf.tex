...
%we could move these papers to the dissusion:
...
To address the aims of this study, we conducted a two-part investigation. First, we collected qualitative survey data using a scenario-based questionnaire. Different AI-assisted decision making processes were described and presented, and participants rated their attitude towards them. Participants also provided information regarding proficiency with AI tools and career which allowed their responses to be categorised.\\

Secondly, we hosted a focus group where participants discussed their sentiment towards AI, rated their attitude to different scenarios and responded to statements made by the hosts relating to trustworthiness in high-stakes applications.\\
